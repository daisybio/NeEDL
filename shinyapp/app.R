  ...
  div(
    ...
    selectInput("score_select", label = h5("Select the score to display"), 
                choices = list("PENETRANCE_NLL" = "PENETRANCE_NLL",
                               ...
                               "REGRESSION_NLL-GAIN" = "REGRESSION_NLL-GAIN",
                               "REGRESSION_LLH-GAIN" = "REGRESSION_LLH-GAIN",
                               "REGRESSION_AIC-GAIN" = "REGRESSION_AIC-GAIN",
                               "REGRESSION_BIC-GAIN" = "REGRESSION_BIC-GAIN",
                               "BAYESIAN" = "BAYESIAN",
