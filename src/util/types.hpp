 ...
 */
        ...
        enum class EpistasisScore {
            ...
            PENETRANCE_AIC = 6,
            PENETRANCE_BIC = 7,
            PENETRANCE_COV_NLL = 8,
            PENETRANCE_COV_LLH = 9,
            PENETRANCE_COV_AIC = 10,
            PENETRANCE_COV_BIC = 11,
            REGRESSION_NLL = 12,
            REGRESSION_LLH = 13,
            REGRESSION_AIC = 14,
            REGRESSION_BIC = 15,
            REGRESSION_NLL_GAIN = 16,
            REGRESSION_LLH_GAIN = 17,
            REGRESSION_AIC_GAIN = 18,
            REGRESSION_BIC_GAIN = 19,
            REGRESSION_COV_NLL = 20,
            REGRESSION_COV_LLH = 21,
            REGRESSION_COV_AIC = 22,
            REGRESSION_COV_BIC = 23,
            REGRESSION_CLG_Q_LC = 24,
            REGRESSION_CLG_Q_QC = 25,
            REGRESSION_CLG_L_LC = 26
